						...
						<div class="modal-body">
							...
							<form action="signup.do" method="POST" onsubmit="return formCheck(this);">
								...
								<input type="text" id="member_name" placeholder="이름을 입력해 주세요"
									name="member_name"><br>
								<input type="text" id="member_phone" placeholder="연락처를 입력해 주세요"
									name="member_phone"><br> <input type="email" id="member_email"
									placeholder="이메일을 입력해 주세요" name="member_email"><br>
